    ...
    try {
        ...
        const result = await transSOHDR.findAll({
            ...
            include: [{
                ...
                required: false,
                attributes: [
                    [Sequelize.fn('SUM', Sequelize.col('trans_so_dtls.total_amount')), 'sum_total'],
                ],
                include: [{
                    model: items,
                    required: false,
                    ...
                    include: [{
                        model: category,
                        attributes: [
                            [Sequelize.fn('COUNT', Sequelize.col('trans_so_dtls.mast_item.mast_item_cats.cat_desc')), 'item_count'],
                            'cat_desc'
                        ],
                    }]
                }],
